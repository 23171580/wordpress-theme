    ...
    <header class="left">
    	...
    	<div class="sns-icon">
        	<ul>
                ...
                <li class="sns-qq"><span>QQ:<?=(get_option('mytheme_qq')!='' ? get_option('mytheme_qq') : '762346892')?></span></li>
                <li class="sns-weichat"><span>微信:<?=(get_option('mytheme_weichat')!='' ? get_option('mytheme_weichat') : 'sun-jeff')?></span></li>
